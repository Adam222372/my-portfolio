        ...
        <div className={"mt-[100px] flex flex-col justify-center items-center"}>
            <div className={"flex justify-center flex-col items-center self-center "}>
                ...
                <form action={"/contact"} method={"POST"} className={"flex flex-col my-8"}>
                    ...
                    <input type={"email"} name={"email"} placeholder={dictionary.contact.email} required={true}
                           className={"border-b-2 border-luxury-gray focus:border-white focus:outline-hidden my-8 w-55"}/>

                    <input type={"text"} name={"subject"} placeholder={dictionary.contact.subject} required={true}
                           className={"border-b-2  border-luxury-gray focus:border-white focus:outline-hidden my-8 w-55"}/>

                    </div>
                   
                    <textarea name={"notes"} placeholder={dictionary.contact.message} required={true}
                    ...
                    <button className={" bg-electric-blue text-white rounded-lg w-25 h-8 cursor-pointer m-4 hover:bg-electric-blue/70 transition font-medium"}>{dictionary.contact.send}</button>
                    </div>
