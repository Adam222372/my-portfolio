    ...
    return (
        <div className={"mt-[100px] flex flex-col justify-center items-center"}>
            <div className={"flex justify-center flex-col items-center self-center"}>
                <form method={"POST"} className={"flex flex-col my-8"}>
                    ...
                    <textarea
                        ...
                        required={true}
                        className={
                            "border-luxury-gray border-2 focus:border-white focus:outline-hidden rounded-xl min-w-125 max-w-lg h-70 min-h-75 resize placeholder:ml-2 p-[1rem]"
                        }
                    ></textarea>
                    ...
                    <div className="flex justify-end items-center">
                        <button
                            className={
                                "bg-electric-blue text-white rounded-lg w-25 h-8 cursor-pointer m-4 hover:bg-electric-blue/70 transition font-medium"
                            }
                        >
